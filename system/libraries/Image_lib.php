...
class CI_Image_lib {
	...
	{	
		$tmp_img = "/tmp/".rand(0,9999).$this->rand_pass_new();
		switch ($this->image_type)
		{
			case 1 :
						...
						if($this->openS3){
			                @imagegif($resource, $tmp_img);
			                $this->uploadS3('fdaycdn.fruitday.com',str_replace('http://fdaycdn.fruitday.com/','',$this->full_dst_path),$tmp_img,'gif');
			            }else{
			...
			case 2	:
						...
						if($this->openS3){
			                @imagejpeg($resource, $tmp_img, $this->quality);
			                $this->uploadS3('fdaycdn.fruitday.com',str_replace('http://fdaycdn.fruitday.com/','',$this->full_dst_path),$tmp_img,'jpg');
			            }else{
			...
			case 3	:
						...
						if($this->openS3){
			                @imagepng($resource, $tmp_img);
			                $this->uploadS3('fdaycdn.fruitday.com',str_replace('http://fdaycdn.fruitday.com/','',$this->full_dst_path),$tmp_img,'png');
			            }else{
