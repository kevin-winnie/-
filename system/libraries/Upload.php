...
class CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		if($this->openS3){
				...
				$this->uploadS3('fdaycdn.fruitday.com',$this->upload_path.$this->file_name,$this->file_temp,trim($this->file_ext,'.'));
				$this->set_image_properties("http://fdaycdn.fruitday.com/".$this->upload_path.$this->file_name);
		}else{
	...
	function uploadS3($bucket = 'fdaycdn.fruitday.com',$s3_key,$t_file,$p_type){
        require_once 'application/plugins/aws/aws-autoloader.php';
    ...
    function deleteS3($bucket = 'fdaycdn.fruitday.com',$s3_key){
    	require_once 'application/plugins/aws/aws-autoloader.php';
    	$client = S3Client::factory ( array (
            'region'=>'cn-north-1',
            'version'=>'latest',
