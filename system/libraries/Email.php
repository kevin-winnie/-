...
class CI_Email {
	...
	var	$smtp_host		= "smtp.fruitday.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "noreply@fruitday.com";		// SMTP Username
	var	$smtp_pass		= "FdaySysEmail2015*^!";		// SMTP Password
