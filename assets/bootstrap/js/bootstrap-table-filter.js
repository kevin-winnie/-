!function($) {
    ...
    BootstrapTableFilter.FILTER_SOURCES = {
        ...
        search: {
            search: false,
            rows: [
                {id: 'eq', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: '等于'}},
                //{id: 'neq', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: '不等于'}},
                {id: 'cnt', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: '包含'}},
                //{id: 'ncnt', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: '不包含'}},
                //{id: 'ept', label: '{%msg}', i18n: {msg: '空'}},
                //{id: 'nept', label: '{%msg}', i18n: {msg: '不空'}}
            ],
            check: function(filterData, value) {
