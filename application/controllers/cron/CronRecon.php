                    ...
                    if(!empty($commercial_array))
                    {
                        foreach($data as $k=>$v)
                        {
                            ...
                            if(in_array($k,$commercial_array))
                            {
                                ...
                                $agent_sale_data[$agent_id]['good_money'] += ($v['order_sale']['alipay']['good_money']+$v['order_sale']['wechat']['good_money']+$v['order_sale']['other']['good_money']);
                ...
                if(!empty($val['commercial']))
                {
                    ...
                    foreach($val['commercial'] as $k1=>$v1)
                    {
                        ...
                        (
                            ...
                            'separate_rate'=>$k1_commercial['separate_rate'],
                ...
                if(!empty($val['agent']))
                {
                    ...
                    foreach($val['agent'] as $k2=>$v2)
                    {
                        ...
                        (
                            ...
                            'shou_platform_id'=>0,
                            'realy_money'=>$val['alipay']+$val['wechat']+$val['other'],
                            'separate_rate'=>$k2_agent['separate_rate'],
