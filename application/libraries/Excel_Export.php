...
class Excel_Export
{
     ...
     * @const :
     */
    const DEFAULT_FILE_NAME = 'excel.xls';

    const DEFAULT_FILE_PATH = "/tmp/survey_excel/";
    ...
    public function toCode($type = 'GB2312', $from = 'auto')
    {
        ...
        {
            $this->_contents[$i] = $this->_toCodeArr($contents,$type);
        }
    ...
    public function saveFile(){
        ...
        $file_content = $header . "\n" . $data;
        file_put_contents(self::DEFAULT_FILE_PATH.$file_name, $file_content);
    }
}
